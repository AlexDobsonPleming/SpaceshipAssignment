...
public class Room {
  ...
  public Room(GL3 gl, float xSize, float zSize, Camera cameraIn, Light[] lights, TextureLibrary textures) {
    Texture chequerboard = textures.get("chequerboard");
    Texture asphalt = textures.get("asphalt");

    floor = new Surface(gl, xSize, zSize, cameraIn, lights, asphalt, Mat4Transform.translate(new Vec3()));
    ...
    ceiling = new Surface(gl, xSize, zSize, cameraIn, lights, chequerboard, ceilingTransform);
    ...
    rearWall = new Surface(gl, xSize, floorToCeilingHeight, cameraIn, lights, chequerboard, rearWallTransform);
    ...
    windowWall = new Window(gl, xSize, floorToCeilingHeight, cameraIn, lights, window, windowWallTransform);
    ...
    wallBehindWindowTest = new Surface(gl, xSize, floorToCeilingHeight, cameraIn, lights, watt, wattWallTransform);
    ...
    oppositeWall = new Surface(gl, xSize, floorToCeilingHeight, cameraIn, lights, chequerboard, oppositeWallTransform);
  }
