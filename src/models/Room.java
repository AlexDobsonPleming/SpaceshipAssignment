...
public class Room {
  ...
  public Room(GL3 gl, Camera cameraIn, ILight[] lights, TextureLibrary textures) {
    ...
    ceiling = new Surface(gl, floorWidth, floorDepth, cameraIn, lights, chequerboard, ceilingTransform);
    ...
    rearWall = new Surface(gl, floorWidth, floorToCeilingHeight, cameraIn, lights, chequerboard, rearWallTransform);
    ...
    oppositeWall = new Surface(gl, floorDepth, floorToCeilingHeight, cameraIn, lights, chequerboard, oppositeWallTransform);
  }
